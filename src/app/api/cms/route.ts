...
const DEFAULT_ROWS = [
  ...
  { key: 'about_quote',      label: 'Section histoire – Citation',         type: 'text',  value_fr: '"C\'est comme ça que tout a commencé."', value_sv: '"Det var så allt började."', value_en: '"That\'s how it all began."' },
