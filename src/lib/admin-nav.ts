...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/marketing/relances', icon: 'remove_shopping_cart',
        label: { fr: 'Paniers abandonnés', en: 'Abandoned baskets', sv: 'Övergivna varukorgar' },
        desc: { fr: 'Relances & geste de la semaine', en: 'Reminders & weekly incentive', sv: 'Påminnelser och veckans erbjudande' } },
